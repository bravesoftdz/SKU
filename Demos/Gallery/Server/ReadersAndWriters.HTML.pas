...
initialization
  TSkuchainMessageBodyRegistry.Instance.RegisterWriter<TCategoryList>(THTMLCategoryListWriter);
  TSkuchainMessageBodyRegistry.Instance.RegisterWriter<TItemList>(THTMLItemListWriter);
